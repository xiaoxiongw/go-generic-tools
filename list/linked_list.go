...
import "github.com/go-generic/internal/errs"

// 检查双向链表LinkedList是否实现List接口
var (
...
func NewLinkedList[T any]() *LinkedList[T] {
	head := &node[T]{}
	// 尾节点的 next 指针指向 head，prev 指针也指向 head。形成一个循环链表。
